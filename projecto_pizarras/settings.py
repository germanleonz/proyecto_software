# Django settings for projecto_pizarras project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'projecto_pizarra',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'projecto_pizarras.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'projecto_pizarras.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/juan/Software/proyecto_software/proyecto_pizarras/templates', 
