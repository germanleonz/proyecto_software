...
var Dajaxice = {
    ...
    modificarActividadAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_actividad.modificarActividadAjax', 'POST', callback_function, argv, custom_settings);
    },

    crearSubactividadAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_actividad.crearSubactividadAjax', 'POST', callback_function, argv, custom_settings);
    },

    asignarActividadAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_actividad.asignarActividadAjax', 'POST', callback_function, argv, custom_settings);
    },

    mostrarActividad: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_actividad.mostrarActividad', 'POST', callback_function, argv, custom_settings);
    },

    crearActividadForm: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_actividad.crearActividadForm', 'POST', callback_function, argv, custom_settings);
    },

    crearComentario: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_actividad.crearComentario', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    modificarPizarraAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_pizarras.modificarPizarraAjax', 'POST', callback_function, argv, custom_settings);
    },

    crearPizarraForm: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_pizarras.crearPizarraForm', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    editarPerfilAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_usuarios.editarPerfilAjax', 'POST', callback_function, argv, custom_settings);
    },

    modificarUsuarioAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_usuarios.modificarUsuarioAjax', 'POST', callback_function, argv, custom_settings);
    },

    cambiarContrasenaAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_usuarios.cambiarContrasenaAjax', 'POST', callback_function, argv, custom_settings);
    },

    crearUsuarioAjax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('app_usuarios.crearUsuarioAjax', 'POST', callback_function, argv, custom_settings);
    }
